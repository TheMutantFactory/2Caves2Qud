...
COURSES = [
    ...
    dict(key="golgotha", name="Golgotha Drop", cup="Chrome Cup", cup_index=7, difficulty=3.0,
         format="3-section race (run as a loop)", target_lap="section race", skill="Forced-movement lane changes",
         ...
         control=[[300, 300], [1200, 200], [2000, 500], [2600, 300], [3300, 700], [3100, 1300], [2400, 1500],
                  [3000, 2000], [2200, 2200], [1400, 1900], [700, 2100], [300, 1400], [700, 800]],
    ...
    dict(key="bethesda", name="Bethesda Susa Deep Freeze", cup="Chrome Cup", cup_index=8, difficulty=3.5,
         format="3-section race (run as a loop)", target_lap="section race", skill="Progressive ice control",
         ...
         control=[[300, 500], [1100, 300], [1900, 600], [2600, 400], [3300, 800], [3200, 1500], [2600, 1900],
                  [2000, 1500], [1500, 2100], [800, 2000], [400, 1400]],
    ...
    dict(key="eynroj", name="Eyn Roj Dreamroot", cup="Canopy Cup", cup_index=12, difficulty=4.0,
         format="3-section descent and ascent (run as a loop)", target_lap="section race", skill="Reading psychic route echoes",
    ...
    dict(key="tomb", name="Tomb of the Eaters Bell Run", cup="Spindle Cup", cup_index=19, difficulty=5.0,
         format="3-section ascent (run as a loop)", target_lap="section race", skill="Timed sanctuary routing", spoiler=True,
         ...
         width=210, elevation=160, laps=3,
         control=[[300, 2100], [1100, 2200], [1600, 1800], [1000, 1400], [1700, 1100], [2500, 1400], [3200, 1900],
                  [3300, 1200], [2700, 700], [1900, 500], [1100, 700], [400, 1200]],
